export const experiences = [
  {
    ...
    current: true,
    bullets: [
      'Working with Playwright automation framework and Page Object Model (POM) concepts for test automation.',
      'Performing manual, functional, regression, smoke, sanity, and UI testing for web applications.',
      'Executing API testing and backend validation using Postman and basic SQL queries.',
      'Creating and maintaining test cases, bug reports, and QA documentation using Jira and Shortcut.',
      'Conducting responsive and cross-browser testing across multiple devices and environments.',
      'Collaborating with developers and Agile/Scrum teams to identify, reproduce, and resolve defects efficiently.',
    ],
  },
  {
    id: 2,
